...
public class BowlingGameTest extends TestCase {
	...
	public void testValidation21() {
        BowlingGame bowlingGame = new BowlingGame("[11,5][3,6][7,2][3,6][4,4][5,3][3,3][4,5][8,1][2,12][10]");
        assertFalse(bowlingGame.validateScores());
    }
	public void testValidation3() {
        BowlingGame bowlingGame = new BowlingGame("[1,5][10,10][7,2][3,6][4,4][5,3][3,3][4,5][8,1][2,8][10]");
        assertFalse(bowlingGame.validateScores());
    }
	...
	public void testValidation12() {
        BowlingGame bowlingGame = new BowlingGame("[10,0][4,6][7,2][3,6][4,4][5,3][3,3][4,5][8,1][10,0][10,10][10,10]");
        assertFalse(bowlingGame.validateScores());
    }
	public void testValidation13() {
        BowlingGame bowlingGame = new BowlingGame("[10,2][4,6][7,2][3,6][4,4][5,3][3,3][4,5][8,1][10,0]");
        assertFalse(bowlingGame.validateScores());
    }
	public void testValidation14() {
        BowlingGame bowlingGame = new BowlingGame("[10,0][4,6][7,2][3,6][4,4][5,3][3,3][4,5][8,1][10,0]");
        assertFalse(bowlingGame.validateScores());
    }
	public void testValidation15() {
        BowlingGame bowlingGame = new BowlingGame("[10,0][4,6][7,2][3,6][4,4][5,3][3,3][4,5][8,1][7,3]");
        assertFalse(bowlingGame.validateScores());
    }
	public void testValidation16() {
